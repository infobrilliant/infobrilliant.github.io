...
if (Modernizr.touch) { 
      ...
      $(window).load(function() {
        ...
        $('body').delay(300).css({'overflow':'visible'});
				...
				setTimeout(function(){$('.windows-preview').addClass('fadeInUp');},300);
...
// Hover & active for live demo buttons

$(document).ready(function() {
    $('.ios-preview').hover(
        function() {
            $(this).find('.btn-middle').toggleClass('visibleButton');
        }, function() {
            $(this).find('.btn-middle').removeClass('visibleButton');
        }
    );

    $('.android-preview').hover(
        function() {
            $(this).find('.btn-middle').toggleClass('visibleButton');
        }, function() {
            $(this).find('.btn-middle').removeClass('visibleButton');
